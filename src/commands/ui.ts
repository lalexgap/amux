...
const HUB_HELP = "f filter · ↑/↓/j/k preview · enter/→ lock in · ctrl-q sidebar · n new · m move · c clone · h handoff · x stop · d remove · a all · g group · r cd · q/esc detach · ctrl-c quit";
