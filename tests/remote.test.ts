...
describe("buildNotifyCommand", () => {
  const base: Config = { notifyOnIdle: true, idleNotifyMinSeconds: 30, remoteControl: true, apiPort: 8787, apiBind: "127.0.0.1", worktreeByDefault: true, commsMaxPerWindow: 5, commsWindowSeconds: 60, outboxTtlHours: 48 };
